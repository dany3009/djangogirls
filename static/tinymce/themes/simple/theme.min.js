// !!! This is code of "modern" theme, copy-pasted from Github, and manually adopted for our needs. Nobody cares. !!!
...
tinymce.ThemeManager.add('simple', function(editor) {
  ...
  // >>> actually, here there is all we've changed:

  // Default menus
  var defaultMenus = {
    // just a music of silence
  };

  var defaultToolbar = "bold italic strikethrough | link unlink";
